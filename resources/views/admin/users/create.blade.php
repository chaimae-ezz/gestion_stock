...
@section('title', 'Ajouter un utilisateur - StockMaster')
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">
                            <i class="far fa-user-plus mr-2"></i>Créer un nouveau compte
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6 bg-gradient-to-r from-orange-500 to-orange-600">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-orange-100 text-sm">Remplissez tous les champs pour créer un nouvel utilisateur</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="bg-orange-50 border border-orange-100 rounded-xl p-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-orange-800">À propos des rôles</h4>
                                    <p class="text-xs text-orange-600 mt-1">
                                        <span class="font-semibold">Administrateur :</span> Accès complet à toutes les fonctionnalités<br>
                                        <span class="font-semibold">Employé :</span> Accès limité à la gestion du stock
                                    </p>
                                </div>
                            </div>
                        </div>
